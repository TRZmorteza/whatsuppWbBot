...
unRead="//span[contains(@aria-label,'unread message')]/ancestor::div[@role='gridcell'][2]"
unread_imgs="//span[contains(text(),'unread')]/following::img[@draggable='true'][contains(@src,'blob:https://web')]"
...
unread_texts="//span[contains(text(),'unread')]/following::div[contains(@class,'message-in')]//div[@class='copyable-text' and normalize-space(.) != '']"